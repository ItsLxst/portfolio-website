...
function Projects() {
    const citelyGithub = process.env.NEXT_PUBLIC_CITELY_GITHUB;
    const citelyLive = process.env.NEXT_PUBLIC_CITELY_LIVE;
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white border-2 border-[#e5ddd4] hover:border-[#d4c7b8] hover:-translate-y-1 hover:shadow-lg transition-all rounded-lg p-6">
                        ...
                        <h3 className="text-xl font-medium text-[#6b1f35] mb-3">Citely</h3>
                        <p className="text-[#8c7b73] text-sm mb-4">
                            A RAG-based document Q&amp;A assistant — upload a PDF, ask questions, and get grounded answers with source citations instead of hallucinated guesses.
                        </p>
                        <div className="flex flex-wrap gap-2 mb-4">
                            ...
                            <span className="bg-[#ede8e1] text-[#3d2e28] text-xs px-3 py-1.5 rounded-lg">ChromaDB</span>
                            <span className="bg-[#ede8e1] text-[#3d2e28] text-xs px-3 py-1.5 rounded-lg">Groq API</span>
                        </div>
                        <div className="flex gap-3">
                            <a href={citelyLive} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[#6b1f35] border-2 border-[#6b1f35] text-sm px-4 py-2 rounded-lg font-medium hover:bg-[#6b1f35] hover:text-white transition-colors">
                                <FiExternalLink size={16} />
                                Live Demo
                            </a>
                            <a href={citelyGithub} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[#3d2e28] border-2 border-[#e5ddd4] text-sm px-4 py-2 rounded-lg font-medium hover:bg-[#1a1210] hover:border-[#1a1210] hover:text-white transition-colors">
                                <FaGithub size={16} />
                                GitHub
                            </a>
                        </div>
